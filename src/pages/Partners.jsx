...
import './Partners.css'; // Importa o arquivo CSS
      ...
      <div className="partners-main-section">
        <div className="partnership-section">
            <div className="partner-container">
                <h1 className="main-title">Ruma é <span className="highlight">Parceria</span></h1>
                <p><b> Na Ruma, encontre a seleção premium de produtos exclusivos e criteriosamente avaliados por nossa curadoria.
                Descubra qualidade e singularidade em cada item escolhido a dedo para você.</b></p>
